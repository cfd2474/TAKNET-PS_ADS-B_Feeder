...
### Recent Improvements (v2.51.3)

- **Bug Fix:** Added navigation button to SDR configuration step
- **Bug Fix:** Removed all external command dependencies (cat, tee) from detection script
