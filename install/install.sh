#!/bin/bash
# TAKNET-PS-ADSB-Feeder One-Line Installer v2.47.46
...
if [ "$UPDATE_MODE" != true ]; then
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "  TAKNET-PS-ADSB-Feeder Installer v2.47.46"
...
echo "  - VERSION..."
wget -q $REPO/VERSION -O /opt/adsb/VERSION 2>/dev/null || echo "2.47.46" > /opt/adsb/VERSION
